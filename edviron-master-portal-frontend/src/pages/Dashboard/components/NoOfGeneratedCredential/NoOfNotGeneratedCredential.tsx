...
function NoOfNotGeneratedCredential() {
  const data = [
    {
  ...
  return (
    <div>
      <BackButton label="No of Credentials Not Sent" />
      <div className="flex justify-end">
        <Link
          to="/credentials-send-list"
          className="px-6 rounded-lg py-3 bg-[#6F6AF8] text-white"
        >
          Credentials Send list
        </Link>
      </div>
      <div>
...
export default NoOfNotGeneratedCredential;
